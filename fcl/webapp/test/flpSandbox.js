					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "flexible 컬럼 레이아웃 연습",
									"targetURL": "#syncebfcl-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"syncebfcl-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.eb.fcl",
									"url": sap.ui.require.toUrl("sync/eb/fcl")
								}
							}
						}
					}
