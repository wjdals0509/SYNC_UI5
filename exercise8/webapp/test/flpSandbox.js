		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21exercise8-display": {
								"semanticObject": "synce21exercise8",
								"action": "display",
								"description": "UX400의 연습문제",
								"title": "Create and Use Fragments",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.exercise8",
									"url": sap.ui.require.toUrl("sync/e21/exercise8")
								}
							}
						}
					}
