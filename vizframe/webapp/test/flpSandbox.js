		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "차트 연습",
									"targetURL": "#syncebvizframe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncebvizframe-display": {
								"semanticObject": "syncebvizframe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.eb.vizframe",
									"url": sap.ui.require.toUrl("sync/eb/vizframe")
								}
							}
						}
					}
