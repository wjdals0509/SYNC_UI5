		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제리뷰 E21",
									"targetURL": "#synce21ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21ex3review-display": {
								"semanticObject": "synce21ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex3review",
									"url": sap.ui.require.toUrl("sync/e21/ex3review")
								}
							}
						}
					}
