		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21exercise13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21exercise13-display": {
								"semanticObject": "synce21exercise13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.exercise13",
									"url": sap.ui.require.toUrl("sync/e21/exercise13")
								}
							}
						}
					}
