					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 E21",
									"targetURL": "#synce21ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce21ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex4",
									"url": sap.ui.require.toUrl("sync/e21/ex4")
								}
							}
						}
					}
