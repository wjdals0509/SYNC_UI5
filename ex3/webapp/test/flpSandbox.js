					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 E21",
									"targetURL": "#synce21ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce21ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex3",
									"url": sap.ui.require.toUrl("sync/e21/ex3")
								}
							}
						}
					}
