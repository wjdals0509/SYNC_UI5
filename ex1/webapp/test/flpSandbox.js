					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제 E21",
									"targetURL": "#synce21ex1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce21ex1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex1",
									"url": sap.ui.require.toUrl("sync/e21/ex1")
								}
							}
						}
					}
