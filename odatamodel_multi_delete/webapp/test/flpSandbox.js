		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "다중 데이터 삭제",
									"targetURL": "#synce21odatamodelmultidelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21odatamodelmultidelete-display": {
								"semanticObject": "synce21odatamodelmultidelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.odatamodelmultidelete",
									"url": sap.ui.require.toUrl("sync/e21/odatamodelmultidelete")
								}
							}
						}
					}
