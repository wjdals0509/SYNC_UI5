					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 E21",
									"targetURL": "#synce21ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce21ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex2",
									"url": sap.ui.require.toUrl("sync/e21/ex2")
								}
							}
						}
					}
