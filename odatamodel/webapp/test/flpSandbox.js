		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21odatamodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21odatamodel-display": {
								"semanticObject": "synce21odatamodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.odatamodel",
									"url": sap.ui.require.toUrl("sync/e21/odatamodel")
								}
							}
						}
					}
