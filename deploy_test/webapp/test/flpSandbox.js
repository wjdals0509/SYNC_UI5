		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21deploytest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21deploytest-display": {
								"semanticObject": "synce21deploytest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.deploytest",
									"url": sap.ui.require.toUrl("sync/e21/deploytest")
								}
							}
						}
					}
