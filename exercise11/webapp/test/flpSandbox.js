		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21exercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21exercise11-display": {
								"semanticObject": "synce21exercise11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.exercise11",
									"url": sap.ui.require.toUrl("sync/e21/exercise11")
								}
							}
						}
					}
