		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제리뷰 E21",
									"targetURL": "#synce21ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21ex2review-display": {
								"semanticObject": "synce21ex2review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ex2review",
									"url": sap.ui.require.toUrl("sync/e21/ex2review")
								}
							}
						}
					}
