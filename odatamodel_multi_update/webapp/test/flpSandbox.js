		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21odatamodelmultiupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21odatamodelmultiupdate-display": {
								"semanticObject": "synce21odatamodelmultiupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.odatamodelmultiupdate",
									"url": sap.ui.require.toUrl("sync/e21/odatamodelmultiupdate")
								}
							}
						}
					}
