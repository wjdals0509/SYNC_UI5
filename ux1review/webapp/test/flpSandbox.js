		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제리뷰 E21",
									"targetURL": "#synce21ux1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21ux1review-display": {
								"semanticObject": "synce21ux1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.ux1review",
									"url": sap.ui.require.toUrl("sync/e21/ux1review")
								}
							}
						}
					}
