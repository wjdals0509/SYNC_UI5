		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Use Data Types and Input Validation",
									"targetURL": "#synce21exercise12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21exercise12-display": {
								"semanticObject": "synce21exercise12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.exercise12",
									"url": sap.ui.require.toUrl("sync/e21/exercise12")
								}
							}
						}
					}
