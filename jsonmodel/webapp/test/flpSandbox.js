		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#synce21jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21jsonmodel-display": {
								"semanticObject": "synce21jsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e21/jsonmodel")
								}
							}
						}
					}
