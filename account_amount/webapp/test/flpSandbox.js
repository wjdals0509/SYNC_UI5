		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FI]계정별 금액",
									"targetURL": "#synczebaccountamount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczebaccountamount-display": {
								"semanticObject": "synczebaccountamount",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zeb.accountamount",
									"url": sap.ui.require.toUrl("sync/zeb/accountamount")
								}
							}
						}
					}
