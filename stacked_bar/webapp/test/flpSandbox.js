		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "감가상각 차트",
									"targetURL": "#synczebstackedbar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczebstackedbar-display": {
								"semanticObject": "synczebstackedbar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zeb.stackedbar",
									"url": sap.ui.require.toUrl("sync/zeb/stackedbar")
								}
							}
						}
					}
