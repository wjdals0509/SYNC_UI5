		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "입력필드의 값 다뤄보",
									"targetURL": "#synce21input-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21input-display": {
								"semanticObject": "synce21input",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.input",
									"url": sap.ui.require.toUrl("sync/e21/input")
								}
							}
						}
					}
