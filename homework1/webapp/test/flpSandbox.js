		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce21homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce21homework1-display": {
								"semanticObject": "synce21homework1",
								"action": "display",
								"description": "SAPUI5를 이용한 테이블 리스트 구현",
								"title": "UI5 – Table &amp; Fragment 활용하기",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e21.homework1",
									"url": sap.ui.require.toUrl("sync/e21/homework1")
								}
							}
						}
					}
